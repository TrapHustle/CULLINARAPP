...
export default async function TempsReelPage() {
  ...
  return (
    <main className="min-h-full bg-[#17130d] px-4 py-5 text-white sm:px-6 sm:py-8 md:px-10">
      <div className="mx-auto max-w-6xl space-y-7">
        <header className="flex flex-wrap items-start justify-between gap-4 sm:gap-6">
          ...
          <Link
            href="/resultats"
            className="w-full rounded-lg border border-white/15 px-4 py-2.5 text-center text-sm font-semibold text-white/70 transition hover:border-[#d4af37]/60 hover:text-[#f2ca50] sm:w-auto"
          >
